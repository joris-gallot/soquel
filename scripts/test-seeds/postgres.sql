...
-- DDL fidelity probe: identity (both flavors), generated stored, non-default
-- collation. Must stay valid on the oldest supported postgres.
CREATE TABLE app.ddl_probe (
  id bigint GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  seq smallint GENERATED BY DEFAULT AS IDENTITY,
  n integer NOT NULL DEFAULT 1,
  n_doubled integer GENERATED ALWAYS AS (n * 2) STORED,
  label text COLLATE "C"
);

INSERT INTO app.ddl_probe (n, label) VALUES (1, 'a'), (2, 'b');
